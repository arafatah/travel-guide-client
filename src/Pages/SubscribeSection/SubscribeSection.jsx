    ...
    return (
      <div>
        <div
          ...
          style={{
            backgroundImage: "url('https://i.ibb.co/gVkbLj0/pexels-9048793.jpg')",
        ...
        >
          <div className="container flex flex-col flex-wrap content-center justify-center p-4 py-20 mx-auto md:p-10">
            <h1 className="text-5xl antialiased font-semibold leading-tight text-center dark:text-gray-100">
              Get Our Updates
            </h1>
